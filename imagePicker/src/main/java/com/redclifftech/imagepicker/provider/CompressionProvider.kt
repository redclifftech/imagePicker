package com.redclifftech.imagepicker.provider
...
import com.redclifftech.imagepicker.ImagePicker
import com.redclifftech.imagepicker.ImagePickerActivity
import com.redclifftech.imagepicker.util.ExifDataCopier
import com.redclifftech.imagepicker.util.FileUtil
import com.redclifftech.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.redclifftech.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
